<div class="maps index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('sender_email_id'); ?></th>
			<th><?php echo $this->Paginator->sort('receiver_email_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($map['Map']['is_active']); ?>&nbsp;</td>
		<td><?php echo h($map['Map']['sender_email_id']); ?>&nbsp;</td>
		<td><?php echo h($map['Map']['receiver_email_id']); ?>&nbsp;</td>
		<td><?php echo h($map['Map']['updated']); ?>&nbsp;</td>
